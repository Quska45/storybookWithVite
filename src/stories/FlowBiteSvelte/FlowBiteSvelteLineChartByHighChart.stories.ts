import FlowBiteSvelteLineChartByHighChart from '../../component/FlowBiteSvelte/FlowBiteSvelteLineChartByHighChart.svelte';
...
export default {
  title: 'Example/FlowBite/FlowBiteSvelteLineChartByHighChart',
  component: FlowBiteSvelteLineChartByHighChart,
  argTypes: {
    host: {
      control: { type: 'select' },
