import FlowBiteSvelteLineChartByPureCanvas from '../../component/FlowBiteSvelte/FlowBiteSvelteLineChartByPureCanvas.svelte';
...
export default {
  title: 'Example/FlowBite/FlowBiteSvelteLineChartByPureCanvas',
  component: FlowBiteSvelteLineChartByPureCanvas,
  argTypes: {
    buttonProps: {
      control: 'object'
    },
