import FlowBiteSvelteLineChartByTuiChart from '../../component/FlowBiteSvelte/FlowBiteSvelteLineChartByTuiChart.svelte';
...
export default {
  title: 'Example/FlowBite/FlowBiteSvelteLineChartByTuiChart',
  component: FlowBiteSvelteLineChartByTuiChart,
  argTypes: {
    host: {
      control: { type: 'select' },
